          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-sm text-gray-500">
                &copy; {new Date().getFullYear()} Apex Strategy Group. All rights reserved.
              </span>
            </div>
            <nav className="flex items-center space-x-6 text-sm text-gray-500">
              ...
              <a href="/case-studies" className="hover:text-primary-700 transition-colors">Case Studies</a>
              <a href="/insights" className="hover:text-primary-700 transition-colors">Insights</a>
