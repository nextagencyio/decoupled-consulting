  ...
  return (
    <div className="text-center py-16">
      <div className="bg-white rounded-lg shadow-sm p-12">
        <h1 className="font-display text-2xl font-semibold text-primary-900 mb-4">Page Not Found</h1>
          ...
          <ErrorBoundary>
            <article className="bg-white rounded-lg shadow-sm overflow-hidden border border-gray-100">
              ...
              <div className="p-6 md:p-8">
                <h1 className="font-display text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-primary-900 mb-4 md:mb-6">{title}</h1>
